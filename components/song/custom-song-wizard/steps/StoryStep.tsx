...
export function StoryStep({
  ...
  return (
    <div className="mx-auto mt-16 max-w-5xl">
      ...
      <section className="mt-8 overflow-hidden rounded-2xl border border-border/80 bg-card/80">
        <button
          type="button"
        ...
        {isIntroOpen ? (
          <div className="border-t border-border/70 px-4 pb-4 pt-3">
            ...
            <div
              className="mt-3 inline-flex rounded-lg bg-muted p-1"
              role="group"
            ...
            <div className="mt-4">
              {spokenMode === "text" ? (
                <>
                  <Textarea
                    className="min-h-[84px] resize-none rounded-xl border-border bg-background text-base leading-7"
                    maxLength={SPOKEN_INTRO_MAX_TEXT_LENGTH}
                ...
                <>
                    ...
                    {spokenIntro ? (
                      <div className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl border border-primary/15 bg-primary/[0.03] px-3 py-3 text-sm font-medium text-foreground sm:ml-auto">
                              ...
                              {[0, 1, 2, 3].map((bar) => (
                                <span
                                  ...
                                  className={cn(
                                    ...
                                    isBlessingPlaying &&
                                      "motion-safe:animate-[song-wave_0.9s_ease-in-out_infinite]",
                                  )}
                                  style={{
                          ...
                          <div className="mt-2 overflow-hidden">
                            {isBlessingPlaying && transcriptSegments.length ? (
                              ...
                              <p className="truncate text-sm text-muted-foreground">
                                {spokenIntroPreview}
                                {spokenIntroPreview &&
                                spokenIntro.transcript.trim().split(/\s+/)
                                  .length > 6
                                  ? "..."
                                  : ""}
                              </p>
                        ...
                        <span className="shrink-0 text-sm text-muted-foreground">
                          ...
                          {SPOKEN_INTRO_MAX_DURATION_SECONDS}s
                        </span>
                      </div>
                    ) : (
                      <span className="text-sm font-medium text-muted-foreground">
                  ...
                  {isRecordingBlessing && (
                    <LiveRecordingPanel
                      ...
                      description={`Recording in progress. Keep this opening under ${SPOKEN_INTRO_MAX_DURATION_SECONDS} seconds.`}
