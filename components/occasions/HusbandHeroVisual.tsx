...
export default function HusbandHeroVisual() {
  return (
    <div className="relative">
      ...
      <div className="relative aspect-[1.6] overflow-hidden rounded-2xl bg-[#32192b] shadow-[0_28px_80px_rgba(69,34,54,0.24)] ring-1 ring-white/80 lg:aspect-[1.42]">
        <Image
          alt="Couple sharing a custom song made for a husband"
          className="object-cover object-center"
          fill
          priority
          sizes="(min-width: 1024px) 48vw, 100vw"
          src="/images/occasions/custom-song-for-husband-hero.webp"
        />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-black text-[#261712]">
                Built around his story
              </p>
              <p className="mt-1 text-xs leading-5 text-[#6f625c]">
                Add the moments, details, and message he will recognize right
                away.
              </p>
            </div>
          </div>
