...
export default function MusicGiftHeroVisual() {
    ...
    <div className="relative [perspective:1600px]">
      ...
      >
        ...
        <div className="relative transition-transform duration-500 ease-out [transform:translate3d(var(--hero-scene-x),var(--hero-scene-y),0)_rotateX(var(--hero-rotate-x))_rotateY(var(--hero-rotate-y))] [transform-style:preserve-3d] will-change-transform">
          <div className="relative aspect-[1.6] overflow-hidden rounded-2xl bg-[#e8d6c8] shadow-[0_28px_80px_rgba(69,34,20,0.2)] ring-1 ring-white/80 lg:aspect-[1.42] [transform:translateZ(0)]">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(115deg,rgba(255,255,255,0.18),transparent_42%,rgba(72,29,14,0.18))]" />
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-black text-[#261712]">
                    Built for music gift reveals
                  </p>
                  <p className="mt-1 text-xs leading-5 text-[#6f625c]">
                    Pair a custom song with lyric art and a keepsake moment they
                    can replay anytime.
                  </p>
                </div>
              </div>
