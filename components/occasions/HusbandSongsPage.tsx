...
import HusbandHeroVisual from "./HusbandHeroVisual";

const createHusbandSongHref = "/create-song?occasion=anniversary&recipient=husband";
...
const benefits: IconBlock[] = [
  {
    title: "Details only he knows",
    description:
      "Add his name, private nicknames, favorite places, small routines, and the memories that make personalized songs for husband feel unmistakably personal.",
    icon: <MessageCircleHeart className="size-6" />,
  },
  {
    title: "His kind of love song",
    description:
      "Choose acoustic, R&B, pop, country, piano ballad, or another sound he already loves—not a generic romance template.",
    icon: <Music2 className="size-6" />,
  },
  {
    title: "Free preview, then refine",
    description:
      "Hear a personalized song for your husband first, then adjust the lyrics, story, or genre until it feels true to your relationship.",
    icon: <Clock3 className="size-6" />,
  },
  {
    title: "A gift he can keep",
    description:
...
const steps = [
  {
    kicker: "01",
    title: "Tell his story",
    description:
      "Share his name, your relationship, a few memories, and the message you want your husband to hear when the chorus lands.",
  },
  {
    kicker: "02",
    title: "Choose the feeling",
    description:
      "Make it romantic, grateful, playful, nostalgic, or hopeful, then select a music style he will want to replay.",
  },
  {
    kicker: "03",
    title: "Preview and personalize",
    description:
      "Listen to the custom song for your husband, refine any line that needs more of your voice, and try another genre if needed.",
  },
  {
    kicker: "04",
...
const moments: IconBlock[] = [
  {
    ...
    description:
      "Celebrate how you met, what you have carried together, and the chapter you are building next with a personalized song for husband.",
    icon: <Heart className="size-5" />,
  },
  {
    title: "Birthday surprise",
    description:
      "Give him something more replayable than a card by turning favorite memories and admiration into a birthday song made just for him.",
    icon: <Gift className="size-5" />,
  },
  {
    title: "Valentine's Day",
    description:
      "Write the love song for your husband that says what a generic playlist cannot say on its own.",
    icon: <MessageCircleHeart className="size-5" />,
  },
  {
    title: "First dance or vow renewal",
    description:
      "Build a slower, story-led song for a first dance, wedding anniversary, or a new set of promises.",
    icon: <PlayCircle className="size-5" />,
  },
  {
    title: "Just because",
    description:
      "A song works when there is no calendar reason at all—only a small detail you want him to know you still notice.",
...
const husbandSongIdeas: IconBlock[] = [
  {
    title: "Personalized songs for husband",
    description:
      "Make the chorus about your central feeling, then use the verses for details: the first date, the ritual you share, the hard season he helped you through, and the future you still want together.",
    icon: <Heart className="size-5" />,
  },
  {
    title: "Songs for husband from wife",
    description:
      "A grateful song is often strongest when it observes rather than exaggerates. Mention what he carries, what he makes possible, and the ways he turns ordinary days into home.",
    icon: <MessageCircleHeart className="size-5" />,
  },
  {
    title: "Customized song for husband",
    description:
  ...
  {
    title: "Best anniversary songs for husband",
    description:
      "Keep the lyrics clear and the tempo unhurried. An anniversary song for your husband should leave room for the moment while still telling a story only the two of you share.",
    icon: <PlayCircle className="size-5" />,
  },
];
...
const exampleBriefs = [
  {
    ...
    text: "Write a warm acoustic song for my husband James from Maya. Mention our first cramped kitchen, Sunday pancakes, the blue toolbox, and how I still choose him in every new season.",
  },
  {
    label: "Grateful wife",
    title: "The way he makes home",
    text: "Create a soulful R&B song for my husband Noah. Thank him for carrying us through a difficult year, mention his late-night tea, our dog Milo, and the peace he brings to our home.",
  },
  {
    label: "Playful couple",
    title: "Our beautiful chaos",
    text: "Make an upbeat indie-pop song for my husband Leo. Include the missed train in Rome, our terrible karaoke duet, Sunday farmer's market trips, and the phrase 'we always find our way'.",
  },
];

const faqs = [
  {
    question: "What should I include in personalized songs for my husband?",
    answer:
      "Include a few real memories, one everyday detail, and the message you most want him to hear. His name or nickname can work naturally in the chorus, but specificity matters more than mentioning every milestone.",
  },
  {
    question: "Can I create a personalized song for my husband if I am not musical?",
    answer:
      "Yes. Start with your story, not a melody. Share the relationship details, choose a style he enjoys, preview the result, and refine the lyrics until they sound true to you.",
  },
  {
    question: "What style works for a love song for my husband?",
    answer:
      "The best style is one he already loves. Acoustic and piano ballads suit intimate messages; R&B and pop feel warm and modern; country works well for plainspoken storytelling.",
  },
  {
    question: "Is a custom song a good anniversary gift for my husband?",
    answer:
  ...
  {
    question: "Can I make a song for my husband's birthday or Valentine's Day?",
    answer:
      "Absolutely. The same custom-song flow works for birthdays, Valentine's Day, Father's Day, weddings, vow renewals, and just-because gifts.",
  },
  {
    question: "Can I use a custom song for a first dance with my husband?",
    answer:
      "Yes. For a first dance or vow renewal, focus on how you met, a few defining moments, and the promise you want to make now. Choose a slower genre if you want room to dance.",
  },
  {
    question: "How is this different from a song for a wife?",
    answer:
      "The flow is the same. This page is written for people searching personalized songs for husband, so the examples, briefs, and CTAs speak to him as the listener.",
  },
];
...
export default function HusbandSongsPage({
  ...
  return (
    <div className="w-full overflow-hidden bg-[#fffaf7] text-[#2b1914]">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[0.9fr_1fr] lg:gap-10">
          <div className="max-w-2xl">
            <div className="inline-flex max-w-full flex-wrap items-center gap-2 rounded-full bg-white/58 px-4 py-2 text-sm text-[#695851] shadow-[0_18px_40px_rgba(92,48,28,0.08),0_2px_10px_rgba(255,255,255,0.35),inset_0_1px_0_rgba(255,255,255,0.78),inset_0_-1px_0_rgba(214,189,176,0.18)] backdrop-blur-xl supports-[backdrop-filter]:bg-white/42">
              ...
              <span>Personalized songs for your husband</span>
            </div>
            ...
            <h1 className="mt-5 max-w-[11ch] text-balance font-sans text-[2.5rem] font-black leading-[0.98] tracking-normal text-[#250f0b] min-[420px]:text-[2.9rem] sm:text-[3.7rem] lg:text-[4.45rem]">
              Personalized Songs for Husband
            </h1>
            ...
            <p className="mt-5 max-w-lg text-base leading-7 text-[#6c5f59] sm:text-lg">
              ...
              out loud into personalized songs for your husband. Create a free preview,
              refine the lyrics, and give him a love song he will
              want to replay long after the reveal.
            </p>

            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <MagneticButton
                href={createHusbandSongHref}
                size="sm"
                trailingArrow
              ...
              >
                Create a Song for My Husband
              </MagneticButton>
              <MagneticButton
                href="#husband-examples"
                prefetch={false}
                size="sm"
                variant="light"
      ...
      <section className="bg-white px-6 py-16 sm:px-8 md:py-20 lg:px-12 xl:px-16">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            ...
            title="A personalized song for your husband says more than a generic gift"
      ...
      <HowItWorksSection
        description="You bring the real details. The song maker turns them into lyrics, music, vocals, and a personalized song for husband that cannot be bought off a shelf."
        eyebrow="How it works"
        steps={steps}
        title="From your memories to a custom love song for your husband"
      />
      ...
      <section className="bg-white px-6 py-16 sm:px-8 md:py-20 lg:px-12 xl:px-16">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            ...
            title="Give him a song for the occasion—or just because"
            description="A custom song for your husband can be romantic, grateful, playful, or quietly emotional. The story and delivery change with the moment."
          />
      ...
      <section className="bg-[#fff4f7] px-6 py-16 sm:px-8 md:py-20 lg:px-12 xl:px-16">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            ...
            title="The details that make a custom song for husband land"
            description="If a song is for your husband, it should sound like it could not belong to anyone else. Use the details below to choose the right angle before you start."
          />

          <div className="mt-12 grid gap-5 md:grid-cols-2">
            {husbandSongIdeas.map((idea) => (
              <article
                key={idea.title}
      ...
      <FAQ
        ctaButtonLabel="Create a Song for My Husband"
        ctaDescription="Add the name, the memories, and the feeling you want him to hear. Start with a free preview today."
        ctaHref={createHusbandSongHref}
        ...
        items={faqs}
        title="Personalized songs for husband questions"
      />
    </div>
  );
}
