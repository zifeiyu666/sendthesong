...
const benefits: Card[] = [
  { title: "Record a song gift they can keep", description: "Turn their name, stories, favorite sounds, and your message into a custom song recorded from one relationship.", icon: <MessageIcon /> },
...
const faqs = [
  { question: "Can I record a song gift without being a musician?", answer: "Yes. Record a song gift by sharing a story, names, and the feeling. The song maker handles lyrics, music, and vocals. Preview it free before you send it." },
